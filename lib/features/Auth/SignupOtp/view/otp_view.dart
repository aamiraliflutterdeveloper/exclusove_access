...
import 'package:exclusive_access/features/Auth/SignupOtp/view/components/otp_form.dart';
              ...
              children: [
                Expanded(
                  child: SingleChildScrollView(
                    child: Form(
                      key: controller.otpSignUpFormKey,
                      child: Column(
                          ...
                          CustomButtonWithoutIcon(
                              ...
                              onPressed: () {
                                if(controller.pinController.length >=5) {
                                  controller.registerOtp(context);
